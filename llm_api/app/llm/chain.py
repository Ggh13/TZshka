...
""" + rules + """
Ты должен проанализировать техническое задание пользователя и проверить его на соответствие 
...
может быть насколько в одном техническом задании пользователя. 
Учитывай, что в тексте может не быть противоречий какому либо правилу составления
хорошего технического задания.
Также ты должен дать объективную оценку качества технического задания.
"""
